...
class UnlimitedAvatar(
  ...
  fun generateImage(): Bitmap? {
    ...
    val modulusNumber = if (nameMark > 0) nameMark - 1 else nameMark // 数据库id自增从1开始
    val randomColor = getRandomColor(absoluteRandomNumber * 30) // 获得背景颜色

    val iconDrawable = context.let {
  ...
  private fun getDrawableArrayList(): ArrayList<Int> {
    ...
    imageArrayList.add(R.drawable.avatar_brown_bear)
    imageArrayList.add(R.drawable.avatar_cattle)
    imageArrayList.add(R.drawable.avatar_elephant)
    imageArrayList.add(R.drawable.avatar_elk)
    imageArrayList.add(R.drawable.avatar_fox)
    imageArrayList.add(R.drawable.avatar_frogrita)
    imageArrayList.add(R.drawable.avatar_giraffe)
    imageArrayList.add(R.drawable.avatar_hippo)
    imageArrayList.add(R.drawable.avatar_jaguar)
    imageArrayList.add(R.drawable.avatar_koala)
    imageArrayList.add(R.drawable.avatar_lion)
    imageArrayList.add(R.drawable.avatar_orangutan)
    imageArrayList.add(R.drawable.avatar_owl)
    imageArrayList.add(R.drawable.avatar_penguin)
    imageArrayList.add(R.drawable.avatar_raccoon)
    imageArrayList.add(R.drawable.avatar_rhinoceros)
    imageArrayList.add(R.drawable.avatar_wolf)
