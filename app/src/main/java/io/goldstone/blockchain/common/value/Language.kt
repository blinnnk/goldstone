...
object CreateWalletText {
	...
	@JvmField val passwordRules = when (currentLanguage) {
	...
	@JvmField val mnemonicBackUp = when (currentLanguage) {
	...
	@JvmField val agreement = when (currentLanguage) {
	...
	@JvmField val agreeRemind = when (currentLanguage) {
	...
	@JvmField val mnemonicBackupAttention = when (currentLanguage) {
	...
	@JvmField val mnemonicConfirmationDescription = when (currentLanguage) {
	...
	@JvmField val password = when (currentLanguage) {
	...
	@JvmField val repeatPassword = when (currentLanguage) {
	...
	@JvmField val name = when (currentLanguage) {
	...
	@JvmField val mnemonicConfirmation = when (currentLanguage) {
...
object ImportWalletText {
	...
	@JvmField val importWallet = when (currentLanguage) {
	...
	@JvmField val mnemonicHint = when (currentLanguage) {
	...
	@JvmField val keystoreHint = when (currentLanguage) {
	...
	@JvmField val privateKeyHint = when (currentLanguage) {
	...
	@JvmField val unvalidPrivateKey = when (currentLanguage) {
	...
	@JvmField val existAddress = when (currentLanguage) {
	...
	@JvmField val exportWrongPassword = when (currentLanguage) {
	...
	@JvmField val privateKeyAlert = when (currentLanguage) {
	...
	@JvmField val mnemonicAlert = when (currentLanguage) {
	...
	@JvmField val mnemonicLengthAlert = when (currentLanguage) {
	...
	@JvmField val pathAlert = when (currentLanguage) {
	...
	@JvmField val addressFromatAlert = when (currentLanguage) {
...
object DialogText {
	...
	@JvmField val backUpMnemonicSucceed = when (currentLanguage) {
	...
	@JvmField val backUpMnemonicDescription = when (currentLanguage) {
	...
	@JvmField val networkTitle = when (currentLanguage) {
	...
	@JvmField val networkDescription = when (currentLanguage) {
	...
	@JvmField val goToBackUp = when (currentLanguage) {
...
object TokenDetailText {
	...
	@JvmField val setTransferCountAlert = when (currentLanguage) {
...
object WalletSettingsText {
	...
	@JvmField val hintAlert = when (currentLanguage) {
	...
	@JvmField val deleteInfoTitle = when (currentLanguage) {
	...
	@JvmField val deleteInfoSubtitle = when (currentLanguage) {
	...
	@JvmField val oldPassword = when (currentLanguage) {
	...
	@JvmField val newPassword = when (currentLanguage) {
	...
	@JvmField val emptyNameAleryt = when (currentLanguage) {
...
object ChainText {
	...
	@JvmField val ropstan = when (currentLanguage) {
	...
	@JvmField val koven = when (currentLanguage) {
...
object QAText {
	...
	@JvmField val whatIsMnemonic = when (currentLanguage) {
	...
	@JvmField val whatIsKeystore = when (currentLanguage) {
	...
	@JvmField val whatIsWatchOnlyWallet = when (currentLanguage) {
	...
	@JvmField val whatIsPrivateKey = when (currentLanguage) {
...
object SplashText {
	...
	@JvmField val slogan = when (currentLanguage) {
