...
object WalletNameText {
	...
	@JvmField val Owl = when (currentLanguage) {
	...
	@JvmField val Bear = when (currentLanguage) {
	...
	@JvmField val Elephant = when (currentLanguage) {
	...
	@JvmField val Rhinoceros = when (currentLanguage) {
	...
	@JvmField val Frog = when (currentLanguage) {
	...
	@JvmField val Koala = when (currentLanguage) {
	...
	@JvmField val Fox = when (currentLanguage) {
	...
	@JvmField val Monkey = when (currentLanguage) {
	...
	@JvmField val Giraffle = when (currentLanguage) {
	...
	@JvmField val Penguin = when (currentLanguage) {
	...
	@JvmField val Wolf = when (currentLanguage) {
	...
	@JvmField val Bull = when (currentLanguage) {
	...
	@JvmField val Deer = when (currentLanguage) {
	...
	@JvmField val Raccoon = when (currentLanguage) {
	...
	@JvmField val Lion = when (currentLanguage) {
	...
	@JvmField val Hippo = when (currentLanguage) {
