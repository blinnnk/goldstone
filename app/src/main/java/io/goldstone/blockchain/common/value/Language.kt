...
object ImportWalletText {
	...
	@JvmField val address = when (currentLanguage) {
...
object WalletText {
	...
	@JvmField val totalAssets = when (currentLanguage) {
	...
	@JvmField val manage = when (currentLanguage) {
	...
	@JvmField val section = when (currentLanguage) {
	...
	@JvmField val addWallet = when (currentLanguage) {
	...
	@JvmField val assetChart = when (currentLanguage) {
		HoneyLanguage.English.code -> "Assets Chart"
		HoneyLanguage.Chinese.code -> "资产图表"
		HoneyLanguage.Japanese.code -> "資産図"
		HoneyLanguage.Korean.code -> "자산 차트"
		HoneyLanguage.Russian.code -> "Диаграмма активов"
		HoneyLanguage.TraditionalChinese.code -> "資產圖表"
		else -> ""
	}

	@JvmField val wallet = when (currentLanguage) {
	...
	@JvmField val historyButton = when (currentLanguage) {
	...
	@JvmField val notifyButton = when (currentLanguage) {
...
object TransactionText {
	...
	@JvmField val transaction = when (currentLanguage) {
	...
	@JvmField val detail = when (currentLanguage) {
	...
	@JvmField val etherScanTransaction = when (currentLanguage) {
	...
	@JvmField val url = when (currentLanguage) {
	...
	@JvmField val confirmTransaction = when (currentLanguage) {
	...
	@JvmField val minerFee = when (currentLanguage) {
	...
	@JvmField val memo = when (currentLanguage) {
	...
	@JvmField val transactionHash = when (currentLanguage) {
	...
	@JvmField val blockNumber = when (currentLanguage) {
	...
	@JvmField val transactionDate = when (currentLanguage) {
	...
	@JvmField val gasPrice = when (currentLanguage) {
	...
	@JvmField val noMemo = when (currentLanguage) {
	...
	@JvmField val tokenSelection = when (currentLanguage) {
	...
	@JvmField val receivedFrom = when (currentLanguage) {
	...
	@JvmField val sentTo = when (currentLanguage) {
	...
	@JvmField val transferResultReceived = when (currentLanguage) {
	...
	@JvmField val transferResultFrom = when (currentLanguage) {
	...
	@JvmField val transferResultSent = when (currentLanguage) {
	...
	@JvmField val transferResultTo = when (currentLanguage) {
	...
	@JvmField val confirmedBlocks = when (currentLanguage) {
...
object TokenDetailText {
	...
	@JvmField val customGas = when (currentLanguage) {
	...
	@JvmField val paymentValue = when (currentLanguage) {
	...
	@JvmField val transferDetail = when (currentLanguage) {
	...
	@JvmField val customMiner = when (currentLanguage) {
	...
	@JvmField val tokenDetail = when (currentLanguage) {
	...
	@JvmField val transferToLocalWalletAlertDescription = when (currentLanguage) {
	...
	@JvmField val transferToLocalWalletAlertTitle = when (currentLanguage) {
...
object CommonText {
	...
	@JvmField val confirm = when (currentLanguage) {
	...
	@JvmField val wrongPassword = when (currentLanguage) {
	...
	@JvmField val succeed = when (currentLanguage) {
	...
	@JvmField val skip = when (currentLanguage) {
	...
	@JvmField val create = when (currentLanguage) {
	...
	@JvmField val cancel = when (currentLanguage) {
	...
	@JvmField val new = when (currentLanguage) {
	...
	@JvmField val next = when (currentLanguage) {
	...
	@JvmField val saveToAlbum = when (currentLanguage) {
	...
	@JvmField val shareQRImage = when (currentLanguage) {
	...
	@JvmField val copyAddress = when (currentLanguage) {
	...
	@JvmField val startImporting = when (currentLanguage) {
	...
	@JvmField val enterPassword = when (currentLanguage) {
	...
	@JvmField val delete = when (currentLanguage) {
	...
	@JvmField val slow = when (currentLanguage) {
	...
	@JvmField val failed = when (currentLanguage) {
		...
		HoneyLanguage.Russian.code -> "НЕ СМОГЛИ"
	...
	@JvmField val from = when (currentLanguage) {
		HoneyLanguage.English.code -> "From"
	...
	@JvmField val to = when (currentLanguage) {
		HoneyLanguage.English.code -> "To"
		HoneyLanguage.Chinese.code -> "发送至"
	...
	@JvmField val all = when (currentLanguage) {
...
object AlertText {
	@JvmField val watchOnly = when (currentLanguage) {
	...
	@JvmField val importWalletNetwork = when (currentLanguage) {
	...
	@JvmField val balanceNotEnough = when (currentLanguage) {
	...
	@JvmField val transferWrongDecimal = when (currentLanguage) {
	...
	@JvmField val emptyTransferValue = when (currentLanguage) {
	...
	@JvmField val gasEditorEmpty = when (currentLanguage) {
	...
	@JvmField val gasLimitValue = when (currentLanguage) {
	...
	@JvmField val transferUnvalidInputFromat = when (currentLanguage) {
	...
	@JvmField val switchLanguage = when (currentLanguage) {
	...
	@JvmField val switchLanguageConfirmText = when (currentLanguage) {
	...
	@JvmField val wrongKeyStorePassword = when (currentLanguage) {
	...
	@JvmField val getRateFromServerError = when (currentLanguage) {
...
object CurrentWalletText {
	...
	@JvmField val Wallets = when (currentLanguage) {
...
object WatchOnlyText {
	...
	@JvmField val enterDescription = when (currentLanguage) {
	...
	@JvmField val intro = when (currentLanguage) {
...
object NotificationText {
	...
	@JvmField val notification = when (currentLanguage) {
		HoneyLanguage.English.code -> "Notifications"
...
object Alert {
	...
	@JvmField val selectCurrency = when (currentLanguage) {
...
object WalletSettingsText {
	...
	@JvmField val copy = when (currentLanguage) {
		HoneyLanguage.English.code -> "Click to Copy Address"
		HoneyLanguage.Chinese.code -> "点击复制地址"
		HoneyLanguage.Japanese.code -> "コピーアドレスをクリックします"
		HoneyLanguage.Korean.code -> "클릭하여 주소 복제"
	...
	@JvmField val checkQRCode = when (currentLanguage) {
	...
	@JvmField val balance = when (currentLanguage) {
	...
	@JvmField val walletName = when (currentLanguage) {
		HoneyLanguage.English.code -> "Wallet Name"
		HoneyLanguage.Chinese.code -> "钱包名称"
	...
	@JvmField val walletNameSettings = when (currentLanguage) {
	...
	@JvmField val walletSettings = when (currentLanguage) {
	...
	@JvmField val passwordSettings = when (currentLanguage) {
	...
	@JvmField val hint = when (currentLanguage) {
		HoneyLanguage.English.code -> "Password Hint"
		HoneyLanguage.Chinese.code -> "密码提示"
		HoneyLanguage.Japanese.code -> "パスワードのヒント"
		HoneyLanguage.Korean.code -> "비밀번호 제시"
	...
	@JvmField val exportKeystore = when (currentLanguage) {
	...
	@JvmField val backUpMnemonic = when (currentLanguage) {
	...
	@JvmField val backUpMnemonicGotBefore = when (currentLanguage) {
	...
	@JvmField val safeAttention = when (currentLanguage) {
...
object ProfileText {
	...
	@JvmField val settings = when (currentLanguage) {
	...
	@JvmField val profile = when (currentLanguage) {
	...
	@JvmField val contacts = when (currentLanguage) {
	...
	@JvmField val currency = when (currentLanguage) {
	...
	@JvmField val language = when (currentLanguage) {
	...
	@JvmField val aboutUs = when (currentLanguage) {
	...
	@JvmField val helpCenter = when (currentLanguage) {
	...
	@JvmField val version = when (currentLanguage) {
	...
	@JvmField val shareApp = when (currentLanguage) {
	...
	@JvmField val pinCode = when (currentLanguage) {
	...
	@JvmField val deletContactAlertTitle = when (currentLanguage) {
	...
	@JvmField val deleteContactAlertDescription = when (currentLanguage) {
...
object EmptyText {
	...
	@JvmField val tokenDetailTitle = when (currentLanguage) {
	...
	@JvmField val tokenDetailSubtitle = when (currentLanguage) {
	...
	@JvmField val searchTitle = when (currentLanguage) {
	...
	@JvmField val searchSubtitle = when (currentLanguage) {
	...
	@JvmField val contractTitle = when (currentLanguage) {
...
object QuotationText {
	...
	@JvmField val market = when (currentLanguage) {
	...
	@JvmField val search = when (currentLanguage) {
	...
	@JvmField val alarm = when (currentLanguage) {
	...
	@JvmField val currentPrice = when (currentLanguage) {
	...
	@JvmField val priceHistory = when (currentLanguage) {
	...
	@JvmField val tokenDescription = when (currentLanguage) {
		HoneyLanguage.English.code -> "Token Description"
	...
	@JvmField val tokenInformation = when (currentLanguage) {
		...
		HoneyLanguage.Russian.code -> "Информация о Токена"
		HoneyLanguage.TraditionalChinese.code -> "Token 信息"
		else -> ""
	}
	@JvmField val tokenInfoLink = when (currentLanguage) {
		HoneyLanguage.English.code -> "Token Link"
		HoneyLanguage.Chinese.code -> "Token 链接"
		HoneyLanguage.Japanese.code -> "トークンリンク"
		HoneyLanguage.Korean.code -> "Token 링크"
		HoneyLanguage.Russian.code -> "Токена Ссылка"
		HoneyLanguage.TraditionalChinese.code -> "Token 鏈接"
		else -> ""
	}

	@JvmField val socimalMedia = when (currentLanguage) {
	...
	@JvmField val tokenDescriptionPlaceHolder = when (currentLanguage) {
	...
	@JvmField val website = when (currentLanguage) {
	...
	@JvmField val whitePaper = when (currentLanguage) {
	...
	@JvmField val startDate = when (currentLanguage) {
	...
	@JvmField val addQuotationChartPlaceholderSubtitle = when (currentLanguage) {
...
object PincodeText {
	...
	@JvmField val repeat = when (currentLanguage) {
	...
	@JvmField val description = when (currentLanguage) {
	...
	@JvmField val countAlert = when (currentLanguage) {
	...
	@JvmField val verifyAlert = when (currentLanguage) {
	...
	@JvmField val turnOnAttention = when (currentLanguage) {
	...
	@JvmField val show = when (currentLanguage) {
	...
	@JvmField val enterPincode = when (currentLanguage) {
	...
	@JvmField val enterPincodeDescription = when (currentLanguage) {
...
object PrepareTransferText {
	...
	@JvmField val addAMemo = when (currentLanguage) {
	...
	@JvmField val price = when (currentLanguage) {
	...
	@JvmField val accountInfo = when (currentLanguage) {
	...
	@JvmField val willSpending = when (currentLanguage) {
...
object ContactText {
	...
	@JvmField val emptyNameAlert = when (currentLanguage) {
	...
	@JvmField val emptyAddressAlert = when (currentLanguage) {
	...
	@JvmField val wrongAddressFormat = when (currentLanguage) {
	...
	@JvmField val contactName = when (currentLanguage) {
...
object ChainText {
	...
	@JvmField val nodeSelection = when (currentLanguage) {
		HoneyLanguage.English.code -> "Node Selection"
		HoneyLanguage.Chinese.code -> "节点选择"
		HoneyLanguage.Japanese.code -> "ノードの選択"
	...
	@JvmField val mainnet = when (currentLanguage) {
	...
	@JvmField val mainnetDescription = when (currentLanguage) {
		HoneyLanguage.English.code -> "The formal production environment \nwhere the assets are of real value"
		HoneyLanguage.Chinese.code -> "正式生产环境中资产具有真正价值"
		HoneyLanguage.Japanese.code -> "正式な生産環境\n資産が本当の価値を持つ場所"
		HoneyLanguage.Korean.code -> "공식 생산 환경 \n자산이 실제 가치를 지닌 곳"
		HoneyLanguage.Russian.code -> "Формальная производственная среда \nгде активы имеют реальную ценность"
		HoneyLanguage.TraditionalChinese.code -> "正式生產環境中資產具有真正價值"
		else -> ""
	}

	@JvmField val testnet = when (currentLanguage) {
		HoneyLanguage.English.code -> "Testnet"
		HoneyLanguage.Chinese.code -> "测试网"
	...
	@JvmField val testnetDescription = when (currentLanguage) {
		...
		HoneyLanguage.Japanese.code -> "テストに使用されるチェーンは、資産は通常無駄です。"
		HoneyLanguage.Korean.code -> "테스트를 위해 사용 된 체인은 일반적으로 무용지물입니다."
		HoneyLanguage.Russian.code -> "Цепочка, используемая для тестирования, не имеет ничего общего."
		HoneyLanguage.TraditionalChinese.code -> "測試鏈上的資產通常是沒有價值的。"
		else -> ""
	}

	@JvmField val goldStoneMain = when (currentLanguage) {
	...
	@JvmField val infuraMain = when (currentLanguage) {
	...
	@JvmField val ropsten = when (currentLanguage) {
	...
	@JvmField val infuraRopsten = when (currentLanguage) {
	...
	@JvmField val infuraKovan = when (currentLanguage) {
	...
	@JvmField val infuraRinkeby = when (currentLanguage) {
	...
	@JvmField val kovan = when (currentLanguage) {
	...
	@JvmField val rinkeby = when (currentLanguage) {
	...
	@JvmField val etcMorden = when (currentLanguage) {
	...
	@JvmField val goldStoneEtcMain = when (currentLanguage) {
	...
	@JvmField val goldStoneEtcMorderTest = when (currentLanguage) {
	...
	@JvmField val etcMainGasTracker = when (currentLanguage) {
...
object LoadingText {
	...
	@JvmField val searchingToken = when (currentLanguage) {
		HoneyLanguage.English.code -> "Searching token information..."
		HoneyLanguage.Chinese.code -> "正在搜索Token信息..."
		HoneyLanguage.Japanese.code -> "Token情報検索中..."
		HoneyLanguage.Korean.code -> "Token시세 검색..."
	...
	@JvmField val transactionData = when (currentLanguage) {
	...
	@JvmField val tokenData = when (currentLanguage) {
...
object QRText {
	...
	@JvmField val savedAttention = when (currentLanguage) {
	...
	@JvmField val shareQRTitle = when (currentLanguage) {
		HoneyLanguage.English.code -> "SHARE QR IMAGE"
		HoneyLanguage.Chinese.code -> "分享二维码"
		HoneyLanguage.Japanese.code -> "QRコードを共有する"
		HoneyLanguage.Korean.code -> "QR코드 공유"
	...
	@JvmField val screenText = when (currentLanguage) {
	...
	@JvmField val unvalidQRCodeAlert = when (currentLanguage) {
	...
	@JvmField val unvalidContract = when (currentLanguage) {
...
object ImporMneubar {
	...
	@JvmField val mnemonic = when (currentLanguage) {
	...
	@JvmField val keystore = when (currentLanguage) {
	...
	@JvmField val privateKey = when (currentLanguage) {
...
object SplashText {
	...
	@JvmField val goldStone = when (currentLanguage) {
...
object DateAndTimeText {
	...
	@JvmField val second = when (currentLanguage) {
	...
	@JvmField val minute = when (currentLanguage) {
	...
	@JvmField val ago = when (currentLanguage) {
	...
	fun getDateText(): HoneyDateUtil.DataText {
		return HoneyDateUtil.DataText(hour,
			week,
			day,
			hour,
			minute,
...
object WalletNameText {
	...
	@JvmField val Leopard = when (currentLanguage) {
