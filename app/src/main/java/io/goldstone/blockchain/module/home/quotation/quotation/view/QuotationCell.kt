    ...
    relativeLayout {
      ...
      chartView
        .apply {
          ...
          val dataSet = LineSet()
          dataSet.apply {
            arrayListOf(Point("a", 10f), Point("b", 30f), Point("c", 50f), Point("d", 20f), Point("e", 70f), Point("a", 10f), Point("b", 30f), Point("c", 50f), Point("d", 20f), Point("e", 70f)).forEach { addPoint(it) }
            // 这个是线的颜色
