...
class PassCodeFragment : BaseFragment<PassCodePresenter>() {
	...
	val isSetPinCode by lazy { arguments?.getBoolean(ArgumentKey.setPinCode) }
	...
	var isVerifyIdentity = false
	var isEnterYourNewPasswordAgain = false
