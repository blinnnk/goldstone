...
object APIPath {
	...
	val getMD5Info: (header: String, size: Int, eosVoteSize: Int, coinRankSize: Int) -> String = {
			header, size, eosVoteSize, coinRankSize ->"$header/index/md5Info?size=$size&coin_rank_size=$coinRankSize&eos_vote_size=$eosVoteSize" }
