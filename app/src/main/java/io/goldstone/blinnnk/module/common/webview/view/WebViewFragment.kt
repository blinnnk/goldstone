package io.goldstone.blinnnk.module.common.webview.view
...
import io.goldstone.blinnnk.module.common.webview.presenter.WebViewPresenter
			...
			scrollView {
				verticalLayout {
					...
					linearLayout {
						...
						imageView(io.goldstone.blinnnk.R.drawable.goldstone_coin_icon) {
						}.lparams {
							width = 36.uiPX()
							height = 36.uiPX()
							topMargin = 7.uiPX()
