...
object WalletText {
	...
	@JvmField
	val recoveryWallets = when (currentLanguage) {
		HoneyLanguage.English.code -> "recovery Wallets"
		HoneyLanguage.Chinese.code -> "recovery Wallets"
		HoneyLanguage.Japanese.code -> "recovery Wallets"
		HoneyLanguage.Korean.code -> "recovery Wallets"
		HoneyLanguage.Russian.code -> "recovery Wallets"
		HoneyLanguage.TraditionalChinese.code -> "recovery Wallets"
		else -> ""
	}
	...
	val deleteAll=
		when (currentLanguage) {
			HoneyLanguage.English.code -> "DELETE ALL"
			HoneyLanguage.Chinese.code -> "DELETE ALL"
			HoneyLanguage.Japanese.code -> "DELETE ALL"
			HoneyLanguage.Korean.code -> "DELETE ALL"
			HoneyLanguage.Russian.code -> "DELETE ALL"
			HoneyLanguage.TraditionalChinese.code -> "DELETE ALL"
			else -> ""
		}
